...
const { registerUser, loginUser, logout, getProfile, getHabits, createHabit, getCuratedHabits, createLog, getLogs } = require("../controllers/authController");
...
router.post('/habit/:habitId/getlogs', getLogs)
