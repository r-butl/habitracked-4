...
describe("Backend Tests", () => {
  ...
  describe('Get Habits test', () => {

    it('should return 400 if userId is not provided', async () => {
      const req = {
        query: {} // Empty query, no userId
      };
      const res = {
        status: jest.fn().mockReturnThis(),
        json: jest.fn()
    ...
    it('should return habits for a given userId', async () => {
      const userId = '12345';
      const mockHabits = [
        { _id: '1', name: 'Drink water', userId },
        { _id: '2', name: 'Exercise', userId },
      ];
  
      // Mocking HabitModel.find
    ...
    it('should return 500 if there is a server error', async () => {
      ...
      // Mocking a rejected promise to simulate error in HabitModel.find
      HabitModel.find.mockRejectedValue(new Error('Database error'));
